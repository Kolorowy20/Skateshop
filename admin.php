...
<img src="img/user.png" alt="konto" id="ikonaU">
  ...
  <div id="glowna">
        <span style="position: relative;top:200px"><a href="admin_zamowienia.php"><input type="button" value="Zamówienia"></a></span>
        <span style="position: relative;top:200px"><a href="admin_uzytkownicy.php"><input type="button" value="Użytkownicy"></a></span>
        <span style="position: relative;top:200px"><a href="zmien.php"><input type="button" value="Zmiana danych"></a></span>
  </div>
