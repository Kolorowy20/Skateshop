...
<img src="img/user.png" alt="konto" id="ikonaU">
    ...
    <div id="logo"> <a href="index.php"><img src="img/logo.jpg" alt="logo"></div></a>xxx
  ...
  <div id="glowna">
    <?php 
      ...
      while ($record = $deski -> fetch_assoc()) {
        ...
        <div class='opis'><img src='deski/Cruiser_v1_1.png' alt='deska' style='width: 410px;'> <br><br><br>
        <p><h4>Dobry, szeroki i wytrzymały deck z 7 warstw klonu kanadyjskiego.
        Z odskokiem do trików i zagłębieniami na koła, aby zminimalizować zgryzienie koła.</p></h4>
        <p><h4>Wszystko po to, aby ułatwić Ci wykonywanie technicznych manewrów na desce i stylowe trików.</p></h4>
        <p><h4>Deskorolka o tej szerokości oznacza również więcej miejsca na stopy, zapewniając większą stabilność.</h4></p>
        </div>
        <div class='koszyk'>
        <h1>$model</h1>
  ...
  <div id="stopka" style="position: absolute; top: 1250px;">
    <div id="kontakt">
      <p class="social">
