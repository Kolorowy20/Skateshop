...
<img src="img/user.png" alt="konto" id="ikonaU">
  ...
  <?php 
      ...
      //$polaczenie = mysqli_connect ("localhost", "id17753443_root", "]^BGzdk+4oHb_wTj", "id17753443_projekt_konrad");
			$deski = mysqli_query($polaczenie, "select * from deski where rodzaj='cruiser'");
      ...
      <div class='opis'><img src='deski/Cruiser_v2_2.png' alt='deska' style='width: 415px;'> <br><br><br>
        <p><h4>Lekka, zwinna i niewielkich rozmiarów deskorolka Maple marki Meteor, jest wręcz stworzona do jazdy w miejskich warunkach.</h4></p>
        <p><h4>Konstrukcja cruisingowa, najlepiej sprawdzi się podczas szybkiego przemieszczania się.</h4></p>
        <p><h4>Niewielka waga deski ułatwia przenoszenie, a wysokie i skrętne trucki umożliwiają prostą i szybką zmianę kierunku jazdy i sprawdzą się podczas trenowania tricków.</h4></p>
        <p><h4>Deskorolka Maple jest odpowiednio wyprofilowana, co pozytywnie wpływa na jakość jazdy. 7-warstwowy deck wykonany został z chińskiego klonu, który jest bardzo wytrzymały i odporny na uderzenia.</h4></p>
        </div>
      <div class='koszyk'>
        <h1>$model</h1>
...
?>
  ...
  <div id="stopka" style="position: absolute; top: 1350px;">
    <div id="kontakt">
      <p class="social">
