...
<img src="img/user.png" alt="konto" id="ikonaU">
  ...
  <?php 
      ...
      <div class='opis'><img src='deski/Cruiser_v3_1.png' alt='deska' style='width: 410px;'> <br><br><br>
        <p><h4>MATERIAŁ - dzięki wykonaniu z 7 warstw wysokiej jakości klonu chińskiego, deska jest bardzo wytrzymała.</h4></p>
        <p><h4>ANTYPOŚLIZGOWA POWIERZCHNIA - zapewnia bardzo dobrą przyczepność oraz doskonale zabezpiecza przed zsunięciem się z deski w czasie jazdy.</h4></p>
        <p><h4>MIĘKKIE KÓŁKA 78A - absorbują wszelkie drgania powstałe w czasie jazdy po nierównościach.</h4></p>
        <p><h4>PRZEZNACZONA DO JAZDY MIEJSKIEJ - dzięki niewielkiemu rozmiarowi i wadze sprawdzi się doskonale podczas jazdy po miejskich, zatłoczonych uliczkach.</h4></p>
        </div>
      <div class='koszyk'>
        <h1>$model</h1>
