...
<img src="img/user.png" alt="konto" id="ikonaU">
  ...
  <?php 
      ...
      <div class='opis'><img src='deski/Deskorolka_v1_1.png' alt='deska' style='width: 350px;'> <br><br><br>
        <p><h4>Enjoi Deskorolka Kompletna jest idealna do rozpoczęcia skejterskiej kariery.</h4></p>
        <p><h4>Enjoi skateboard jest odpowiednia dla wszystkich poziomów umiejętności, tylko czeka, aż zabierzesz ją na ulice lub do skateparku.</h4></p>
        <p><h4>Ta kompletna deskorolka wyposażona we wszystkie odpowiednie części, jest praktycznie gotowa do jazdy wprost po wyjęciu jej z pudełka.</h4></p>
        </div>
      <div class='koszyk'>
        <h1>$model</h1>
...
?>
  ...
  <div id="stopka" style="position: absolute; top: 1260px;">
    <div id="kontakt">
      <p class="social">
