...
<img src="img/user.png" alt="konto" id="ikonaU">
  ...
  <?php 
      ...
      <div class='opis'><img src='deski/Deskorolka_v2_1.png' alt='deska' style='width: 370px;'> <br><br><br>
        <p><h4>Klasyczna deskorolka wyczynowa przeznaczona do jazdy street, ewolucji na rampach i skate-parku.</h4></p>
        <p><h4>Wykonana z 7 warstw wytrzymałego drewna.</h4></p>
        <p><h4>Powierzchnia pokryta antypoślizgową grip tape w kolorze czarnym.</h4></p>
        <p><h4>Wyposażona w 5-cio calowe trucki i koła z syntetycznego kauczuku o wymiarach 56x36 mm i twardości 92A oraz łożyska ABEC 7.</h4></p>
        </div>
      <div class='koszyk'>
        <h1>$model</h1>
...
?>
  ...
  <div id="stopka" style="position: absolute; top: 1290px;">
    <div id="kontakt">
      <p class="social">
