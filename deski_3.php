...
<img src="img/user.png" alt="konto" id="ikonaU">
  ...
  <?php 
      ...
      //$polaczenie = mysqli_connect ("localhost", "id17753443_root", "]^BGzdk+4oHb_wTj", "id17753443_projekt_konrad");
			$deski = mysqli_query($polaczenie, "select * from deski where rodzaj='deski'");
      ...
      <div class='opis'><img src='deski/Deskorolka_v3_1.png' alt='deska' style='width: 410px;'> <br><br><br>
        <p><h4>Deskorolka to produkt skierowany zarówno do osób stawiających swoje pierwsze kroki w tym sporcie, jak i bardziej zaawansowanych riderów.</h4></p>
        <p><h4>Jej uniwersalny rozmiar sprawia, że nadaje się ona zarówno dla dziecka, nastolatka jak i osoby dorosłej.</h4></p>
        <p><h4>Dzięki wysokiej jakości komponentów bez obaw będziesz mógł na niej naukę trików deskorolkowych.</h4></p>
        <p><h4>Wszystkie elementy są w standardowych rozmiarach.</h4></p>
        </div>
      <div class='koszyk'>
        <h1>$model</h1>
...
?>
  ...
  <div id="stopka" style="position: absolute; top: 1320px;">
    <div id="kontakt">
      <p class="social">
