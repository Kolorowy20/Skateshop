...
<img src="img/user.png" alt="konto" id="ikonaU">
  ...
  <?php 
      ...
      //$polaczenie = mysqli_connect ("localhost", "id17753443_root", "]^BGzdk+4oHb_wTj", "id17753443_projekt_konrad");
			$deski = mysqli_query($polaczenie, "select * from deski where rodzaj='longboard'");
      ...
      <div class='opis'><img src='deski/Longboard_v1_1.png' alt='deska' style='width: 370px;'> <br><br><br>
        <p><h4>Jego konstrukcja sprawia, że fantastycznie sprawdza się podczas jazdy w mieście - profil camber wraz z lekkim concave to gwarancja znakomitego czucia deski, a co za tym idzie zwiększony komfort jazdy poprzez jego zwrotnośćy.</h4></p>
        <p><h4>Twin Tip to kształt stworzony do wykonywania trików, a topolowo-jesionowy rdzeń, sidewalle z poliuretanu oraz konstrukcja z włókna szklanego sprawiają, że longboard Switch charakteryzuje się doskonałą elastycznością przy zachowaniu niezwykle wytrzymałej konstrukcji.</h4></p>
        <p><h4>Trucki montowane od góry pozwalają na obniżenie środka ciężkości na desce.</h4></p>
        </div>
      <div class='koszyk'>
        <h1>$model</h1>
