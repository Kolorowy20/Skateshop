...
<img src="img/user.png" alt="konto" id="ikonaU">
  ...
  <?php 
      ...
      <div class='opis'><img src='deski/Longboard_v2_1.png' alt='deska' style='width: 370px;'> <br><br><br>
        <p><h4>Przeznaczona do łatwej nauki jazdy na longboardzie.</h4></p>
        <p><h4>Idealna dla osób o małych gabarytach, na przejażdżki lub do przemieszczania się po mieście w zabawny sposób.</h4></p>
        <p><h4>Longboard o shapie drop, aby ułatwić naukę. niska deska o obniżonym środku ciężkości, dla maksymalnej stabilności.</h4></p>
        </div>
      <div class='koszyk'>
        <h1>$model</h1>
