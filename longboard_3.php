...
<img src="img/user.png" alt="konto" id="ikonaU">
  ...
  <?php 
      ...
      <div class='opis'><img src='deski/Longboard_v3_1.png' alt='deska' style='width: 350px;'> <br><br><br>
        <p><h4>Deskorolka Longboard MASTER 41' wykonana jest z ośmiowarstwowego drewna klonowego o wymiarach 104 cm x 24 cm.</h4></p>
        <p><h4>Pozwala na bardzo przyjemną jazdę po mieście oraz umożliwia proste triki na longboardzie.</h4></p>
        <p><h4>Przeznaczona jest dla początkujących oraz zaawansowanych użytkowników.</h4></p>
        <p><h4>Posiada klasyczny kształt pintail, który jest szeroki i dodatkowo poprawia właściwości deski.</h4></p>
        <p><h4>Jest zbudowany do surfowania po mieście w najwygodniejszy carvingowy sposób.</h4></p>
        </div>
      <div class='koszyk'>
        <h1>$model</h1>
