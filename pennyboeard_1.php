...
<img src="img/user.png" alt="konto" id="ikonaU">
  ...
  <?php 
      ...
      <div class='opis'><img src='deski/Pennyboard_v1_1.png' alt='deska' style='width: 390px;'> <br><br><br>
        <p><h4>Niewielki rozmiar i waga sprawiają, że deskorolka jest łatwa w transporcie i przenoszeniu.</h4></p>
        <p><h4>Idealnie nadaje się do miejskiej jazdy po zatłoczonych, wyboistych chodnikach.</h4></p>
        <p><h4>Antypoślizgowa powierzchnia doskonale zabezpiecza przed zsunięciem się z deski, natomiast miękkie kółka umożliwiają szybką jazdę oraz świetnie absorbują wszelkie drgania powstałe w czasie jazdy po nierównościach.</h4></p>
        <p><h4>Dzięki wykonaniu z połączenia wysokiej jakości klonu kanadyjskiego oraz drewna bambusowego, jest niezwykle wytrzymała oraz zachowuje swój kształt, nawet przy ciężkich upadkach i lądowaniach.</h4></p>
        </div>
      <div class='koszyk'>
        <h1>$model</h1>
...
?>
  ...
  <div id="stopka" style="position: absolute; top: 1140px;">
    <div id="kontakt">
      <p class="social">
