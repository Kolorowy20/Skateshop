...
<img src="img/user.png" alt="konto" id="ikonaU">
  ...
  <?php 
      ...
      <div class='opis'><img src='deski/Pennyboard_v2_1.png' alt='deska' style='width: 380px;'> <br><br><br>
        <p><h4>Pennyboard Art Sky Nils Extreme charakteryzuje się nowatorskim designem nawiązującym do motywów związanych z niebem i kosmosem. Deskorolka została wykonana ze sztucznego tworzywa o nazwie polipropylen, w skrócie PP.</h4></p>
        <p><h4>Użycie tego rodzaju materiału przekłada się na dużą wytrzymałość deskorolki, większą niż w przypadku typowych deskorolek, wykonanych z drewnianej sklejki.</h4></p>
        <p><h4>Górna strona deskorolki ma formę kratownicy, która powoduje lepszą przyczepność.</h4></p>
        <p><h4>Małe rozmiary pozwalają bez problemu zmieścić ją nawet do niewielkiego plecaka.</h4></p>
        <p><h4>Pennyboard dostosowano do użytku przez osoby w każdym wieku.</h4></p>
        <p><h4>Nie jest przeznaczony robienia trików i grindowania.</h4></p>
        </div>
      <div class='koszyk'>
        <h1>$model</h1>
