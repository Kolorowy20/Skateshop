...
<img src="img/user.png" alt="konto" id="ikonaU">
  ...
  <?php 
      ...
      //$polaczenie = mysqli_connect ("localhost", "id17753443_root", "]^BGzdk+4oHb_wTj", "id17753443_projekt_konrad");
			$deski = mysqli_query($polaczenie, "select * from deski where rodzaj='pennyboard'");
      ...
      <div class='opis'><img src='deski/Pennyboard_v3_1.png' alt='deska' style='width: 380px;'> <br><br><br>
        <p><h4>WORKER Sunbow 22' jest deskorolką wykonaną z tworzywa sztucznego, która przyciąga wzrok, poprzez swój barwny design</h4></p>
        <p><h4>Powierzchnia deski oraz jej kształt mają za zadanie zapobieganie jakiemukolwiek ślizganiu się  się po deskorolce Penny.</h4></p>
        <p><h4>Szybka i przyjemna jazda jest zagwarantowana dzięki zastosowaniu wysokiej jakości łożysk ABEC7 z maksymalną precyzją wykonania deskorolki.</h4></p>
        <p><h4>Dodatkowo kompaktowe wymiary i niewielka waga sprawiają, że pennyboard WORKER Sunbow można mieć zawsze przy sobie.</h4></p>
        <p><h4>Ciekawa kolorystyka nowoczesny design i pełna funkcjonalność sprawiają, że deskorolka Sunbow usatysfakcjonuje najbardziej wymagających.</h4></p>
        </div>
      <div class='koszyk' style='position: fixed;top: 240px; right: 440px;'>
        <h1>$model</h1>
...
?>
  ...
  <div id="stopka" style="position: absolute; top: 1340px;">
    <div id="kontakt">
      <p class="social">
