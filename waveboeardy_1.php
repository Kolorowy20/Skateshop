...
<img src="img/user.png" alt="konto" id="ikonaU">
  ...
  <?php 
      ...
      <div class='opis'><img src='deski/Waveboard_v1_1.png' alt='deska' style='width: 190px; margin-left: 70px;'> <br><br><br>
        <p><h4>Jeśli uwielbiasz skating pod każdą postacią koniecznie musisz spróbować jazdy na waveboardzie!</h4></p>
        <p><h4>Najlepiej na modelu marki, na którym będziesz szlifował swoje umiejętności oraz doświadczysz nowych, napełniających krew adrenaliną wrażeń.</h4></p>
        <p><h4>Waveboard posiada dwa kółka, przymocowane na przodzie i tyle deski, które mogą się obracać o 360°.</h4></p>
        <p><h4>Dwa decki deski połączone są skrętnym drążkiem dla lepszej elastyczności. </h4></p>
        </div>
      <div class='koszyk'>
        <h1>$model</h1>
...
?>
  ...
  <div id="stopka" style="position: absolute; top: 1370px;">
    <div id="kontakt">
      <p class="social">
