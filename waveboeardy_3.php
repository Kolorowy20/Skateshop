...
<img src="img/user.png" alt="konto" id="ikonaU">
  ...
  <?php 
      ...
      <div class='opis'><img src='deski/Waveboard_v3_1.png' alt='deska' style='width: 190px; margin-left: 90px;'> <br><br><br>
        <p><h4>Profesjonalny waveboard przystosowany do ekstremalnej jazdy, jest prawdopodobnie najlepiej dopracowanym modelem wavebordów.</h4></p>
        <p><h4>Skrętne kółka posiadają blokady całkowitego obrotu o 360 stopni, punkty graniczne wyposażone w sprężyny, dzięki czemu jazda idzie bardzo gładko i płynnie.</h4></p>
        <p><h4>Deck idealnie wyprofilowany, o ergonomicznym kształcie, posiada małe wypustki oraz antypoślizgowy grip, co zapewnia maksymalną przyczepność.</h4></p>
        <p><h4>Pod deckiem aluminiowy przegób, dzięki czemu całość elastycznie pracuje podczas jazdy i doskonale dostosowuje się do ruchów użytkownika oraz do rodzaju podłoża.</h4></p>
        </div>
      <div class='koszyk'>
        <h1>$model</h1>
...
?>
  ...
  <div id="stopka" style="position: absolute; top: 1440px;">
    <div id="kontakt">
      <p class="social">
