...
<img src="img/user.png" alt="konto" id="ikonaU">
    ...
    <a href="index.php"><div id="logo"><img src="img/logo.jpg" alt="logo"></div></a>
  ...
  <?php 
      ...
      //$polaczenie = mysqli_connect ("localhost", "id17753443_root", "]^BGzdk+4oHb_wTj", "id17753443_projekt_konrad");
			$deski = mysqli_query($polaczenie, "select * from deski");
      ...
      while ($record = $deski -> fetch_assoc()) {
        ...
        $opis = $record['opis'];
			  ...
			  if ($id == 1)
					echo"
    <div class='wszystkie'>
    <a href='cruiser_1.php'>
      <img src='deski/Cruiser_v1_1.png' alt='deska'>
      <p class='nazwa' style='padding-top: 5px;'>$model</p>
      ...
      echo"
    <div class='wszystkie'>
      <a href='cruiser_2.php'>
      <img src='deski/Cruiser_v2_2.png' alt='deska'>
      <p class='nazwa' style='padding-top: 18px;'>$model</p>
      <p class='nazwa'>$cena zł</p>
    </a>
    </div>
    ";
    else if ($id == 3)
      echo "<div class='wszystkie'>
      <a href='cruiser_3.php'>
      <img src='deski/Cruiser_v3_1.png' alt='deska'>
    ...
    <div class='wszystkie'>
      <a href='deski_1.php'>
      <img src='deski/Deskorolka_v1_1.png' alt='deska'>
      <p class='nazwa' style='padding-top: 5px;' >$model</p>
      <p class='nazwa'>$cena zł</p>
    </a>
    </div>";
    ...
    <div class='wszystkie'>
      <a href='deski_2.php'>
      <img src='deski/Deskorolka_v2_1.png' alt='deska' style='margin-left: -20px;'>
      <p class='nazwa' style='padding-top: 18px;'>$model</p>
      <p class='nazwa'>$cena zł</p>
    </a>
    </div>";
    ...
    <div class='wszystkie'>
      <a href='deski_3.php'>
      <img src='deski/Deskorolka_v3_1.png' alt='deska' style='height: 410px;'>
      <p class='nazwa' style='margin-top: 30px;'>$model</p>
      <p class='nazwa'>$cena zł</p>
    </a>
    </div>";
    else if ($id == 7)
      echo "
    <div class='wszystkie'>
      <a href='longboard_1.php'>
      <img src='deski/Longboard_v1_1.png' alt='deska'>
      <p class='nazwa' style='margin-top: 28px;'>$model</p>
      <p class='nazwa'>$cena zł</p>
    </a>
    </div>";
    else if ($id == 8)
      echo "
    <div class='wszystkie'>
      <a href='longboard_2.php'>
      <img src='deski/Longboard_v2_1.png' alt='deska' style='margin-top: 10px;'>
      <p class='nazwa' style='margin-top: 30px;'>$model</p>
      <p class='nazwa'>$cena zł</p>
    </a>
    </div>";
      ...
      echo "
    <div class='wszystkie'>
      <a href='longboard_3.php'>
      <img src='deski/Longboard_v3_1.png' alt='deska'>
      <p class='nazwa'>$model</p>
      <p class='nazwa'>$cena zł</p>
    </a>
    </div>";
    ...
    <div class='wszystkie'>
      ...
      echo "
    <div class='wszystkie'>
      <a href='pennyboeard_1.php'>
      <img src='deski/Pennyboard_v1_1.png' alt='deska' style='height: 270px;'>
      <p class='nazwa' style='margin-top: 40px;'>$model</p>
      <p class='nazwa'>$cena zł</p>
    </a>
    </div>";
				else if ($id == 14)
				echo "
    <div class='wszystkie'>
      <a href='pennyboeard_2.php'>
      <img src='deski/Pennyboard_v2_1.png' alt='deska' style='height: 280px;'>
      <p class='nazwa' style='margin-top: 33px;'>$model</p>
      <p class='nazwa'>$cena zł</p>
    </a>
    </div>";
    else if ($id == 15)
      echo "
    <div class='wszystkie'>
      <a href='pennyboeard_3.php'>
      <img src='deski/Pennyboard_v3_1.png' alt='deska'>
      <p class='nazwa'>$model</p>
      <p class='nazwa'>$cena zł</p>
    </a>
    </div>
...
<div id="stopka" style="position: absolute; top: 3150px;">
<div id="kontakt">
  <p class="social">
